          ...
          list.map((item) => {
            return (
              ...
              <List key={item._id}
                ...
                <Box>
                  <Button variant="contained" color="success" sx={{ mx: 3 }} onClick={() => editData(item)}> Edit</Button>
                  <Button variant="contained" color="error" sx={{ mx: 3 }} onClick={() => deleteData(item._id)}> Delete</Button>
                </Box>
              </List>
